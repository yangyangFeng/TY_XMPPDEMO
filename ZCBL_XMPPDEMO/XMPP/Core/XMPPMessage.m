...
- (NSString *)bodytype
{
    return [[self elementForName:@"bodytype"] stringValue];
}
...
- (void)addBodyType:(NSString *)bodytype
{
    
    NSXMLElement *bodyElement = [NSXMLElement elementWithName:@"bodytype" stringValue:bodytype];
    [self addChild:bodyElement];
}
